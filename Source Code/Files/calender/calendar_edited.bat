...
if exist a.temp goto exist
goto loop
:exist
set /a s= < s.txt
set /a v= < v.txt
color %v%%s%
ren a.temp year_file.txt
set /a year= < year_file.txt
goto p
:loop
...
GOTO del
:del
if exist year_file.txt goto delete
goto forget
:delete
del /q s.txt && del /q v.txt
del /q year_file.txt
pause
cd..
call menu.cmd
...
:forget
cls
color 12 && (title exiting.........) && (timeout -t -1) 
exit