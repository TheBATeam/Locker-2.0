@echo off
if exist points\moderate\complete.km goto run
goto poly[1]
:run
set /a kvc=0
set /p q= < level.temp
...
set /a a[1]=%random%
if %a[1]% gtr 9999 goto simple
goto r[1]
:r[1]
cls
set /a a[2]=%random%
if %a[2]% gtr 9999 goto r[1]
goto poo[1]
:poo[1]
set /a a=(14-12)/12
SET /a Y=(9-%a%)
...
set /a e=%g%/7
set /a a[1]=%g%-%e%*7
If %a[1]% lss 25 goto x[2]
goto s(44)
:a
cls
set /a a[1]=%a[1]%+1
if %a[1]% gtr 25 ((set /a a[1]=0) && goto aa)
goto aa
:aa
set /a a[2]=%a[2]%+3
if %a[2]% gtr 25 ((set /a a[2]=0) && goto x[2])
goto x[2]
:aaa
set sign=+
goto game
...
goto a
:x[2]
title Fasten your calculation...........		LEVEL: Difficult !!!!!
